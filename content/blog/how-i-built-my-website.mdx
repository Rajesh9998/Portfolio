...
<a href="https://tailwindcss.com/" className="mb-6 inline-block cursor-pointer rounded-sm bg-blue-500 py-2 px-4 font-bold text-white! duration-200 hover:bg-blue-600">
 <span>Tailwind</span>
</a>

```js {1} title="page.tsx" showLineNumbers
