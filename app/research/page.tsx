  ...
  <section className="mt-6 mb-16 overflow-hidden md:mt-12 lg:mt-20">
   ...
   <div className="relative mt-3 ml-3 flex flex-col items-start justify-center border-l border-neutral-200 dark:border-neutral-800">
    {posts.map((post, index) => (
     <div key={`/research/${post.slug}`} className="-mt-px mb-10 ml-6">
      <Link href={`/research/${post.slug}`} className="block rounded-2xl border border-neutral-200 px-6 py-3 duration-200 hover:bg-neutral-200/50 motion-reduce:transition-none dark:border-neutral-800 dark:bg-[#161617] dark:hover:border-neutral-700 dark:hover:bg-[#202021]">
      ...
      {post.metadata.publicationUrl && (
        <a 
          ...
          className="mt-2 inline-flex items-center rounded-md px-2 py-1 text-sm bg-blue-50 text-blue-700 hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-300 dark:hover:bg-blue-900/40"
        >
